// copilot.js — Adapter for copilot.microsoft.com
...
/**
 * Find the textarea by searching the iframe contentDocument first,
 * then falling back to the main document.
 * @returns {Element|null}
 */
function findElement() {
  // Try iframe contentDocument first (Copilot embeds its chat in an iframe)
...
function init(changeCallback) {
  ...
  if (!element) {
    console.warn('[Trace] Could not locate textarea on copilot');
...
/**
 * Read the active model from the Copilot UI.
 * @returns {string}
 */
function getModelId() {
